...
public class MainRegistro {
    ...
    public MainRegistro(String[] args) {
     ...
     // Crea un oggetto risultato e usa il metodo ultimoVoto di studente per  interrogare il db
    ...
    // Crea un oggetto assenza e usa il metodo ultimaAssenza di Studente per interrogare il db
    ...
    // Crea un oggetto di tipo avviso e usa il metodo ultimoAvviso di Studente per interrogare il db
    ...
    //Riempe la label di intestazione iniziale della schermata
    ...
    //Crea una lista di Lezioni, usa il metodo lezioniOggi di studente per popolarla e le inserisce nell'oggetto grafico
    ...
    private void initialize(String[] args) {
    	...
    	//e ottenere tutte le informazioni sullo studente.
        try {

            SQLConnection sqlconn = new SQLConnection("studente", "studentePss");
        ...
        // vengono richiamati tutti i metodi per effettuare le interrogazioni al db
        // e riempire gli oggetti dell'interfaccia grafica
